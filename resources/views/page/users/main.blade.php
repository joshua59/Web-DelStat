                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    ...
                                    <!--end::Export-->
                                    <!--begin::Add user-->
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalCreateUsers">
                                            ...
                                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                ...
                                                <form id="form_create_users">
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(assets/media/avatars/blank.png)">
                                                                ...
                                                                <label for="foto_profil_users" class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
                                                                    ...
                                                                    <!--begin::Inputs-->
                                                                    <input type="file" name="foto_profil" id="foto_profil_users" />
                                                    ...
                                                    <div class="text-center pt-15">
                                                        ...
                                                        <button id="tombol_kirim_users" onclick="upload_form_modal('#tombol_kirim_users','#form_create_users','{{route('users_store')}}','#ModalCreateUsers');" class="btn btn-primary">
                                                            Submit
                                                        </button>
                                                    </div>
                                                    <!--end::Actions-->
